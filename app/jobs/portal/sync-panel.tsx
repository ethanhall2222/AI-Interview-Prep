...
export default function PortalSyncPanel() {
  ...
  return (
    <section className="rounded-3xl border border-slate-800/60 bg-slate-900/65 p-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-lg font-semibold text-slate-100">Sync Job Feed</h2>
          <p className="text-sm text-slate-400">
            Pull latest postings from configured sources into your portal.
          </p>
        </div>
